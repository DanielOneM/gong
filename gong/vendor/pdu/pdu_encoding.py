...
from gong.vendor.pdu import smpp_time
from gong.vendor.pdu import constants, pdu_types, operations
from gong.vendor.pdu.error import PDUParseError, PDUCorruptError
...
class OptionEncoder(IEncoder):
    ...
    def __init__(self):
        from gong.vendor.pdu.pdu_types import Tag as T
        self.length = None
        self.options = {
